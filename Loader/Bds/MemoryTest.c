  ...
  )
{
  ...
  TmpStr = NULL; //GetStringById (STRING_TOKEN (STR_ESC_TO_SKIP_MEM_TEST));
  ...
  do {
    ...
    if (ErrorOut && (Status == EFI_DEVICE_ERROR)) {
      TmpStr = NULL; //GetStringById (STRING_TOKEN (STR_SYSTEM_MEM_ERROR));
      if (TmpStr != NULL) {
        PrintXY (10, 10, NULL, NULL, TmpStr);
        FreePool (TmpStr);
      }
    ...
    if (TestPercent != PreviousValue) {
      ...
      TmpStr = NULL; //GetStringById (STRING_TOKEN (STR_MEMORY_TEST_PERCENT));
      if (TmpStr != NULL) {
        //
      ...
      TmpStr = NULL; //GetStringById (STRING_TOKEN (STR_PERFORM_MEM_TEST));
      if (TmpStr != NULL) {
        PlatformBdsShowProgress (
          Foreground,
          Background,
...
Done:
  ...
  TmpStr = NULL; //GetStringById (STRING_TOKEN (STR_MEM_TEST_COMPLETED));
  if (TmpStr != NULL) {
