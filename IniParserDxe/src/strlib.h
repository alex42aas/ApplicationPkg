...
typedef struct {
  unsigned char *buf;      // A pointer to the file buffer
  size_t        totalLen; // Total length of file's data
  unsigned char *_p;       // Current possition in the buffer
  size_t        _r;       // Read space
} memFile_t;
